...
class TestContentAgnosticVisualizer(TestVisualizerBase):
    @pytest.fixture
    def visualizer(self, canvas_size: CanvasSize, labels: list[str]) -> ContentAgnosticVisualizer:
        return ContentAgnosticVisualizer(canvas_size=canvas_size, labels=labels)
    
    def test_convert_to_serialized_output_data(self, visualizer: ContentAgnosticVisualizer, processed_layout_data: ProcessedLayoutData):
    ...
    def test_convert_to_serialized_output_data_missing_labels(self, visualizer: ContentAgnosticVisualizer):
    ...
    def test_convert_to_serialized_output_data_missing_discrete_bboxes(self, visualizer: ContentAgnosticVisualizer):
    ...
    def test_get_sorted_layouts_by_area(self, visualizer: ContentAgnosticVisualizer):
        layouts = [
            SerializedData(class_name="small", coord=Coordinates(left=0, top=0, width=10, height=10)),  # area = 100
            SerializedData(class_name="large", coord=Coordinates(left=0, top=0, width=20, height=30)),  # area = 600
            SerializedData(class_name="medium", coord=Coordinates(left=0, top=0, width=15, height=20))  # area = 300
        ]
    ...
    def test_get_sorted_layouts_same_area(self, visualizer: ContentAgnosticVisualizer):
        layouts = [
            SerializedData(class_name="first", coord=Coordinates(left=0, top=0, width=10, height=10)),   # area = 100
            SerializedData(class_name="second", coord=Coordinates(left=0, top=0, width=5, height=20))   # area = 100
        ]
    ...
    def test_draw_layout_bboxes_with_resize_ratio(self, visualizer: ContentAgnosticVisualizer):
        image = Image.new("RGB", (200, 200), (255, 255, 255))
    ...
    def test_draw_layout_bboxes_unknown_class(self, visualizer: ContentAgnosticVisualizer):
        image = Image.new("RGB", (200, 200), (255, 255, 255))
    ...
    def test_invoke_with_processed_layout_data(self, visualizer: ContentAgnosticVisualizer, processed_layout_data: ProcessedLayoutData):
    ...
    def test_invoke_with_serialized_output_data(self, visualizer: ContentAgnosticVisualizer, serialized_output_data: SerializedOutputData):
        config = {"configurable": ContentAgnosticVisualizerConfig().model_dump()}
    ...
    def test_invoke_with_custom_resize_ratio(self, visualizer: ContentAgnosticVisualizer, serialized_output_data: SerializedOutputData):
        config = {"configurable": ContentAgnosticVisualizerConfig(resize_ratio=2.0).model_dump()}
    ...
    def test_invoke_with_custom_background_color(self, visualizer: ContentAgnosticVisualizer, serialized_output_data: SerializedOutputData):
        config = {"configurable": ContentAgnosticVisualizerConfig(bg_rgb_color=(255, 0, 0)).model_dump()}
    ...
    def test_invoke_with_none_config(self, visualizer: ContentAgnosticVisualizer, serialized_output_data: SerializedOutputData):
...
class TestContentAwareVisualizer(TestVisualizerBase):
    ...
    @pytest.fixture
    def visualizer(self, canvas_size: CanvasSize, labels: list[str]) -> ContentAwareVisualizer:
        return ContentAwareVisualizer(canvas_size=canvas_size, labels=labels)

    def test_draw_content_bboxes_basic(self, visualizer: ContentAwareVisualizer, bg_image: Image.Image, content_bboxes: np.ndarray):
    ...
    def test_draw_content_bboxes_with_resize_ratio(self, visualizer: ContentAwareVisualizer, bg_image: Image.Image, content_bboxes: np.ndarray):
        result_image = visualizer.draw_content_bboxes(bg_image, content_bboxes, resize_ratio=1.5)
        
        assert isinstance(result_image, Image.Image)
        # Coordinates should be scaled by resize_ratio

    def test_draw_content_bboxes_custom_font_color(self, visualizer: ContentAwareVisualizer, bg_image: Image.Image, content_bboxes: np.ndarray):
        result_image = visualizer.draw_content_bboxes(bg_image, content_bboxes, font_color=(255, 0, 0))
        
        assert isinstance(result_image, Image.Image)

    def test_draw_content_bboxes_empty_array(self, visualizer: ContentAwareVisualizer, bg_image: Image.Image):
    ...
    def test_invoke_with_processed_layout_data(self, visualizer: ContentAwareVisualizer, processed_layout_data: ProcessedLayoutData, bg_image: Image.Image, content_bboxes: np.ndarray):
        config = {"configurable": ContentAwareVisualizerConfig(
            bg_image=bg_image,
    ...
    def test_invoke_with_serialized_output_data(self, visualizer: ContentAwareVisualizer, serialized_output_data: SerializedOutputData, bg_image: Image.Image):
        config = {"configurable": ContentAwareVisualizerConfig(bg_image=bg_image).model_dump()}
    ...
    def test_invoke_without_content_bboxes(self, visualizer: ContentAwareVisualizer, serialized_output_data: SerializedOutputData, bg_image: Image.Image):
    ...
    def test_invoke_with_resize_ratio(self, visualizer: ContentAwareVisualizer, serialized_output_data: SerializedOutputData, bg_image: Image.Image):
        config = {"configurable": ContentAwareVisualizerConfig(
            bg_image=bg_image,
            resize_ratio=0.5
        ).model_dump()}
    ...
    def test_invoke_with_different_bg_image_mode(self, visualizer: ContentAwareVisualizer, serialized_output_data: SerializedOutputData):
        # Test with RGBA background image
        rgba_image = Image.new("RGBA", (100, 150), (128, 128, 128, 255))
        config = {"configurable": ContentAwareVisualizerConfig(bg_image=rgba_image).model_dump()}
    ...
    def test_invoke_image_resizing(self, visualizer: ContentAwareVisualizer, serialized_output_data: SerializedOutputData):
        # Test with background image of different size
        large_bg_image = Image.new("RGB", (200, 300), (128, 128, 128))
        config = {"configurable": ContentAwareVisualizerConfig(bg_image=large_bg_image).model_dump()}
