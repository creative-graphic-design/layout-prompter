...
from layout_prompter.utils.image import pil_to_base64, base64_to_pil, generate_color_palette
...
class TestImageUtils:
    ...
    def test_base64_to_pil_invalid_string(self):
        ...
        with pytest.raises(Exception):  # Could be various exceptions depending on invalid format
