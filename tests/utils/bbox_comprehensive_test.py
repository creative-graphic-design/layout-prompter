...
from layout_prompter.utils.bbox import normalize_bboxes, decapsulate, convert_ltwh_to_ltrb
...
class TestBboxUtilsComprehensive:
    ...
    def test_normalize_bboxes_basic(self):
        ...
        expected = np.array([[0.1, 0.1, 0.3, 0.2], [0.5, 0.3, 0.7, 0.4]], dtype=np.float32)
