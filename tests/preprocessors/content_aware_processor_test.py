...
class TestContentAwareProcessor(LayoutPrompterTestCase):
    ...
    def test_content_aware_processor_hashable(self):
        ...
        processor1 = ContentAwareProcessor(canvas_size=CanvasSize(width=100, height=100))
        processor2 = ContentAwareProcessor(canvas_size=CanvasSize(width=100, height=100))
        ...
        assert processor_dict[processor1] == "second"  # processor2 overwrites processor1
