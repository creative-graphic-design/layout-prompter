...
class TestDiscretizeBboxes:
    ...
    def test_invoke_with_layout_data(self, discretizer: DiscretizeBboxes, sample_layout_data: LayoutData):
    ...
    def test_invoke_with_processed_data(self, discretizer: DiscretizeBboxes, sample_processed_data: ProcessedLayoutData):
    ...
    def test_discretize_invalid_shape(self, discretizer: DiscretizeBboxes):
        ...
        with pytest.raises(AssertionError, match="bboxes should be of shape \\(N, 4\\)"):
