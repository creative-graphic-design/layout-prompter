...
def test_is_small_bbox_edge_cases():
    ...
    both_small_sides_bbox = [0, 0, 77, 78]  # area = 77*78 = 6006 > min_area, but both sides <= min_side
    ...
    small_by_area_bbox = [0, 0, 85, 70]  # width=85 > 80, height=70 < 80, area=5950 < 6000
...
def test_filtering_disabled():
    ...
    assert result is not None or result is None  # Depends on the exact contour detection
