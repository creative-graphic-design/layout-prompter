...
class TestLexicographicSort:
    ...
    def sample_layout_data(self) -> LayoutData:
        ...
        return LayoutData(
            idx=0,
            bboxes=np.array([[0.1, 0.5, 0.3, 0.7], [0.2, 0.2, 0.4, 0.4], [0.0, 0.5, 0.2, 0.7]]),
    ...
    def test_invoke_with_layout_data_sorts_by_position(self, sorter: LexicographicSort, sample_layout_data: LayoutData):
        ...
        expected_bboxes = np.array([[0.2, 0.2, 0.4, 0.4], [0.0, 0.5, 0.2, 0.7], [0.1, 0.5, 0.3, 0.7]])
    ...
    def test_invoke_with_processed_data_sorts_by_position(self, sorter: LexicographicSort, sample_processed_data: ProcessedLayoutData):
    ...
    def test_invoke_same_top_different_left(self, sorter: LexicographicSort):
        ...
        layout_data = LayoutData(
            idx=3,
            bboxes=np.array([[0.8, 0.5, 1.0, 0.7], [0.2, 0.5, 0.4, 0.7], [0.5, 0.5, 0.7, 0.7]]),
        ...
        expected_bboxes = np.array([[0.2, 0.5, 0.4, 0.7], [0.5, 0.5, 0.7, 0.7], [0.8, 0.5, 1.0, 0.7]])
    ...
    def test_invoke_different_top_same_left(self, sorter: LexicographicSort):
        ...
        layout_data = LayoutData(
            idx=4,
            bboxes=np.array([[0.3, 0.8, 0.5, 1.0], [0.3, 0.2, 0.5, 0.4], [0.3, 0.5, 0.5, 0.7]]),
        ...
        expected_bboxes = np.array([[0.3, 0.2, 0.5, 0.4], [0.3, 0.5, 0.5, 0.7], [0.3, 0.8, 0.5, 1.0]])
    ...
    def test_invoke_reading_order_pattern(self, sorter: LexicographicSort):
        ...
        expected_labels = np.array(["top-left", "top-right", "bottom-left", "bottom-right"])
    ...
    def test_invoke_with_processed_data_resets_discrete_fields(self, sorter: LexicographicSort):
    ...
    def test_invoke_zero_coordinates(self, sorter: LexicographicSort):
        ...
        layout_data = LayoutData(
            idx=12,
            bboxes=np.array([[0.0, 0.0, 0.2, 0.2], [0.0, 0.1, 0.2, 0.3], [0.1, 0.0, 0.3, 0.2]]),
        ...
        expected_bboxes = np.array([[0.0, 0.0, 0.2, 0.2], [0.1, 0.0, 0.3, 0.2], [0.0, 0.1, 0.2, 0.3]])
